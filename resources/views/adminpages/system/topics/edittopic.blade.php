                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="input-group mb-2">
                            <input type="text" id="inputanswer" ng-disabled="topicData.selectedverifytype.id===true" class="form-control" ng-model="topicData.answer" maxlength="40">
                            <div class="input-group-append">
                                <button ng-disabled="topicData.selectedverifytype.id===true" class="btn btn-outline-secondary" type="button" uib-tooltip="添加其它可选答案" tooltip-placement="left" ng-click="addoptionalanswer()">
